namespace ElUtilitySuite.Trackers
{
    ...
    internal class WardTracker : IPlugin
    {
        ...
        {
            var wardtrackerMenu = rootMenu.AddSubMenu("Wardtracker", "wardtracker");
            {
                wardtrackerMenu.Add("wardtracker.TimeFormat", new ComboBox("Time Format", 0, "mm:ss", "ss"));
                wardtrackerMenu.Add("wardtracker.FontSize", new Slider("Font Size", 13, 3, 30));
                wardtrackerMenu.Add("wardtracker.CircleRadius", new Slider("Circle Radius", 150, 25, 300));
                wardtrackerMenu.Add("wardtracker.CircleThickness", new Slider("Circle Thickness", 2, 1, 10));
                wardtrackerMenu.Add("wardtracker.GreenCircle", new CheckBox("Green Circle"));
                ...
                wardtrackerMenu.Add("wardtracker.VisionRange", new CheckBox("Vision Range"));
                wardtrackerMenu.Add("wardtracker.Minimap", new CheckBox("Minimap"));
                wardtrackerMenu.Add("wardtracker.FilterWards", new Slider("Filter Wards", 250, 0, 600));
                wardtrackerMenu.Add("wardtracker.Hotkey", new KeyBind("Hotkey", false, KeyBind.BindTypes.HoldActive, 16));
                wardtrackerMenu.Add("wardtracker.PermaShow", new CheckBox("Perma Show", false));
                wardtrackerMenu.Add("wardtracker.Enabled", new CheckBox("Enabled"));
            }
