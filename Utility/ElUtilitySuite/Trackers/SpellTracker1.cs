namespace ElUtilitySuite.Trackers
{
    ...
    internal class SpellTracker : IPlugin
    {
        ...
        {
            var cooldownMenu = rootMenu.AddSubMenu("Cooldown tracker", "cdddddtracker");
            {
                cooldownMenu.Add("cooldown-tracker-TimeFormat", new ComboBox("Time Format", 0, "mm:ss", "ss"));
                cooldownMenu.Add("cooldown-tracker-FontSize", new Slider("Font Size", 13, 3, 30));
                cooldownMenu.Add("cooldown-tracker-Enemy", new CheckBox("Enemy"));
                cooldownMenu.Add("cooldown-tracker-Ally", new CheckBox("Ally"));
                cooldownMenu.Add("cooldown-tracker-Self", new CheckBox("Self"));
                cooldownMenu.Add("cooldown-tracker-Enabled", new CheckBox("Enabled"));
            }
            ...
            try
            {
                        ...
                        hero => hero != null && hero.IsValid && hero.IsHPBarRendered && hero.Position.LSIsOnScreen()))
                {
                    try
                    {
                        ...
                        var y = (int)hero.HPBarPosition.Y + (hero.IsEnemy ? 3 : (hero.IsMe ? -2 : 0));
