namespace ElUtilitySuite.Trackers
{
    ...
    internal class HealthTracker : IPlugin
    {
        ...
        {
            var enemySidebarMenu = rootMenu.AddSubMenu("Enemy healthbars", "healthenemies");
            {
                enemySidebarMenu.Add("DrawHealth_", new CheckBox("Activated"));
                enemySidebarMenu.Add("DrawHealth_percent", new CheckBox("Champion health %"));
                enemySidebarMenu.Add("HealthTracker.OffsetText", new Slider("Offset Text", 30, 0, 100));
                enemySidebarMenu.Add("HealthTracker.OffsetTop", new Slider("Offset Top", 75, 0, 1500));
                enemySidebarMenu.Add("HealthTracker.OffsetRight", new Slider("Offset Right", 170, 0, 1500));
