...
namespace AutoJungle
{
    internal class Program
    {
        ...
        {
            menu = MainMenu.AddMenu("S7-AutoJungle", "AutoJungle");

            menu.Add("Enabled", new CheckBox("Enabled"));
            menu.Add("AutoClose", new CheckBox("Close at the end"));

            menu.AddGroupLabel("Jungle settings");
            menu.Add("HealtToBack", new Slider("Recall on HP(%)", 35, 0, 100));
            menu.Add("UseTrinket", new CheckBox("Use Trinket"));
            menu.Add("EnemyJungle", new CheckBox("Go into enemy jungle"));

            menu.AddGroupLabel("Gank settings");
            menu.Add("GankLevel", new Slider("Min level to gank", 5, 1, 18));
            menu.Add("GankFrequency", new Slider("Ganking frequency", 100, 0, 100));
            menu.Add("GankRange", new Slider("Searching range", 7000, 0, 20000));
            menu.Add("ComboSmite", new CheckBox("Use Smite"));

            menu.AddGroupLabel("Debug");
